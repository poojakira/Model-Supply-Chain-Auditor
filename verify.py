"""
Model Supply Chain Auditor - Verification
...
# Craft a malicious pickle that would execute os.system("whoami")
# This is what a real supply chain attack looks like
class MaliciousPayload:
    def __reduce__(self):
        return (os.system, ("whoami",))

# Serialize WITHOUT executing (pickle.dumps just creates bytes)
...
from src.signing import generate_signing_keypair, sign_model, verify_model, compute_model_hash
...
try:
    ...
    # Tamper with model and verify (should fail)
