...
RULES = {
    "PICKLE000": {"name": "ParseError", "shortDescription": "Failed to parse pickle file", "level": "note"},
    "PICKLE001": {"name": "DangerousImport", "shortDescription": "Import of dangerous module detected", "level": "error"},
    "PICKLE002": {"name": "CodeExecution", "shortDescription": "Code execution opcode with dangerous callable", "level": "error"},
    "PICKLE003": {"name": "StateInjection", "shortDescription": "State injection via BUILD opcode", "level": "warning"},
    "PICKLE004": {"name": "SuspiciousChain", "shortDescription": "Suspicious REDUCE chain depth", "level": "warning"},
    "PICKLE005": {"name": "PostStopPayload", "shortDescription": "Opcodes found after STOP (hidden payload)", "level": "error"},
}
...
def to_sarif(result: PickleScanResult, filepath: str) -> dict[str, Any]:
    ...
    for finding in result.findings:
        ...
        if rule_id not in rules_used:
            rules_used[rule_id] = RULES.get(rule_id, {
                "name": rule_id,
